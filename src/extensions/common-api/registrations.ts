 ...
 */
export type { StatusBarRegistration } from "../../behaviours/status-bar/renderer/status-bar/status-bar-registration";
...
export type { TrayMenuRegistration } from "../../behaviours/tray/main/tray-menu-registration";
